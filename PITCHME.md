...
* На това бяло петно от възможните типове, ние можем да дефинираме целите числа. |
...
* Можем да имаме много функции от типа 'Int -> Int'.
...
* Типовата система е съвкупност от множества със стрелки между тях. |
...
#HSLIDE
#### Сума
* В някои функционални езици имаме pattern matching. |
...
* Можем да приемем и самите тях за типове, макар и типове, които не могат да имат стойности. |
...
#HSLIDE
## Тип-конструктори
* С помощта на generics/templates в C++ и Java имаме нещо като тип-конструктори.
...
* Забележете, че __&ast; -> (&ast; -> &ast;)__ е като  __&ast; -> &ast; -> &ast;__ и е различно от __(&ast; -> &ast;) -> &ast;__.
